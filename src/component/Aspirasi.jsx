      ...
      <div className="w-layout-blockcontainer card_home w-container">
        <div className="columns_aspirasi w-row">
          <div className="teks_konten w-col w-col-6">
            ...
            <p className="paragraph_konten">Mengacu data Sistem Informasi Kesehatan Hewan Nasional (ISIKHNAS) pada
              november 2023, telah ditemukan 115.067 hewan ruminansia terjangkit penyakit diseluruh indonesia. Ini
              disebabkan karena kurangnya pengetahuan peternak untuk mencegah dan menyembuhkan penyakit pada hewan
              ternak mereka.</p>
            <p className="paragraph_konten">Terkait data diatas kami ingin menyediakan informasi untuk membantu peternak
              dan memberikan layanan jaringan koneksi antar komunitas peternak serta memberikan konsultasi
              edukatif terkait ilmu peternakan dan kesehatan hewan.</p>
          </div>
