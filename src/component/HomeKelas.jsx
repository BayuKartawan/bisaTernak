const HomeKelas = () => {
  return (
    <div>
      <section
        data-w-id="7b776f0b-f4cf-3228-73cd-fc779ffe4f7b"
        className="componen_kelas">
        <div className="w-layout-blockcontainer container_isi w-container">
          <div className="columns_aspirasi w-row">
            <div
              data-w-id="7b776f0b-f4cf-3228-73cd-fc779ffe4f7e"
              className="teks_konten_kelas w-col w-col-6">
              <h1 className="judul_konten">Kelas Online</h1>
              <h1 className="judul_konten2">BisaTernak?</h1>
              <p className="paragraph_konten">
                Bingung memulai bisnis peternakan? Mulai dari ikut kelas online
                aja dulu, ada banyak ilmu untuk bekal kamu yang ingin memulai
                bisnis peternakan
              </p>
              <div className="div-block">
                ...
                <div className="list_kelas">
                  ...
                  <p className="teks_list_kelas">
                    Mengelolah sumber daya obatdan vaksinasi Hewan
                  </p>
                </div>
                <div className="list_kelas">
              ...
              <a href="#" className="button_oren w-button">
                Kunjungi Kelas Ternak Kami
              </a>
            </div>
            <div
              data-w-id="7b776f0b-f4cf-3228-73cd-fc779ffe4f87"
              className="gambar_konten_kelas w-col w-col-6">
